...
export default class CodeMirrorPreferences extends CodeMirrorPanel {
     ...
     */
    dialogConfig: { [section: string]: string[] };

    /**
     * Cached default preferences.
     */
    private defaultPreferences?: { [key: string]: boolean };
     ...
     */
    private get mwConfigDefaults(): { [key: string]: boolean | number[] | string[] };

    /**
     * MediaWiki config for primary preferences.
     */
    private get mwConfigPrimary(): { [key: string]: boolean };
     ...
     */
    private setPreferencesInternal(storageObj: { [key: string]: number } | null): void;
